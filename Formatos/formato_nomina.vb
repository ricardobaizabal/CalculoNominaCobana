...
Partial Public Class formato_nomina
    ...
    Private Sub formato_cfdi_NeedDataSource(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.NeedDataSource
        ...
        'Me.txtAntiguedad.Visible = False
        'Me.txtAntiguedadValue.Visible = False
        ...
        If Periodo = 0 Then
            Sql = "EXEC pConsultarConceptosUtilidadesPDF @pNoEmpleado='" & NoEmpleado.ToString & "', @pEjercicio='" & Ejercicio.ToString & "', @pTipo='U', @pPeriodo='" & Periodo.ToString & "'"
        Else
