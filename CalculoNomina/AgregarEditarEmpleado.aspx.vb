...
Public Class AgregarEditarEmpleado
    ...
    Private Sub btnGuardarEmpleado_Click(sender As Object, e As EventArgs) Handles btnGuardarEmpleado.Click
        If Page.IsValid Then
            ...
            Try
                excedente_dinero = Convert.ToDecimal(txtExcedenteMonetario.Text.ToString)
            Catch ex As Exception
                excedente_dinero = 0
            End Try
    ...
    Private Sub EditEmployee(ByVal id As Integer)
        ...
        Try
            ...
            If rs.Read Then
                ...
                lblNoEmpleadoValue.Text = rs("clave")
    ...
    Private Sub EditaContrato(ByVal id As Integer)
        ...
        Try
            ...
            Dim cmd As New SqlCommand("EXEC pContrato @cmd=4, @contratoid='" & id.ToString & "', @clienteid='" & Session("IdEmpresa").ToString & "', @userid='" & Session("usuarioid").ToString & "'", conn)
