<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="ModificacionGeneralQuincenal.aspx.vb" Inherits="CalculoNomina.ModificacionGeneralQuincenal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function OpenWindow(id, empleadoid, contratoid, nominaid) {
            ...
            var oWnd = radopen("IncidenciasQuincenal.aspx?id=" + id + "&empleadoid=" + empleadoid + "&contratoid=" + contratoid + "&nominaid=" + nominaid, "RadWindow1");
            oWnd.set_modal(true);
            ...
            oWnd.set_title("Modificación de nómina ordinaria quincenal - Incidencias")
            oWnd.center();
        }
        ...
        function OnRequestStart(target, arguments) {
            if ((arguments.get_eventTarget().indexOf("grdEmpleadosQuincenal") > -1)) {
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" HorizontalAlign="NotSet" LoadingPanelID="RadAjaxLoadingPanel1" ClientEvents-OnRequestStart="OnRequestStart">
        ...
        <div class="ibox-content" style="border: solid 0px">
            <fieldset>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <telerik:RadGrid ID="grdEmpleadosQuincenal" runat="server" AutoGenerateColumns="false" AllowPaging="false" AllowSorting="true" ShowFooter="true" ExportSettings-ExportOnlyData="false" ShowStatusBar="true" PageSize="20" CellSpacing="0" GridLines="None" Skin="Bootstrap" AllowFilteringByColumn="true">
                            ...
                            <MasterTableView AllowMultiColumnSorting="true" AllowFilteringByColumn="true" NoMasterRecordsText="No hay registros para mostrar." DataKeyNames="NoEmpleado, IdContrato, CuotaDiaria, IntegradoIMSS, IdContrato, idNomina">
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn UniqueName="Faltas" AllowFiltering="false">
                                        ...
                                        <ItemTemplate>
                                            <telerik:RadNumericTextBox ID="txtFaltas" runat="server" MinValue="0" Value="0" Type="Number" NumberFormat-DecimalDigits="2" OnTextChanged="txtFaltas_TextChanged" AutoPostBack="true" Text='<%# Eval("Faltas") %>' Skin="Default" Width="80px" TabIndex="1" MaxValue="15" MaxLength="2" AllowFiltering="false">
                                    ...
                                    <telerik:GridTemplateColumn UniqueName="IncapacidadEG" AllowFiltering="false">
                                        ...
                                        <ItemTemplate>
                                            <telerik:RadNumericTextBox ID="txtIncapacidadEG" runat="server" MinValue="0" Value="0" Type="Number" NumberFormat-DecimalDigits="2" OnTextChanged="txtIncapacidadEG_TextChanged" AutoPostBack="true" Text='<%# Eval("IncapacidadEG") %>' Skin="Default" Width="80px" TabIndex="2" MaxValue="15" MaxLength="2" AllowFiltering="false">
                                                <NumberFormat DecimalDigits="2" GroupSeparator="," />
                                                <EnabledStyle HorizontalAlign="Right" />
                                            </telerik:RadNumericTextBox>
                                        </ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn UniqueName="IncapacidadRT" AllowFiltering="false">
                                        ...
                                        <ItemTemplate>
                                            <telerik:RadNumericTextBox ID="txtIncapacidadRT" runat="server" MinValue="0" Value="0" Type="Number" NumberFormat-DecimalDigits="2" OnTextChanged="txtIncapacidadRT_TextChanged" AutoPostBack="true" Text='<%# Eval("IncapacidadRT") %>' Skin="Default" Width="80px" TabIndex="3" MaxValue="15" MaxLength="2" AllowFiltering="false">
                                                <NumberFormat DecimalDigits="2" GroupSeparator="," />
                                                <EnabledStyle HorizontalAlign="Right" />
                                            </telerik:RadNumericTextBox>
                                        </ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn UniqueName="IncapacidadMaterna" AllowFiltering="false">
                                        ...
                                        <ItemTemplate>
                                            <telerik:RadNumericTextBox ID="txtIncapacidadMaterna" runat="server" MinValue="0" Value="0" Type="Number" NumberFormat-DecimalDigits="2" OnTextChanged="IncapacidadMaterna_TextChanged" AutoPostBack="true" Text='<%# Eval("IncapacidadMaterna") %>' Skin="Default" Width="80px" TabIndex="4" MaxValue="15" MaxLength="2" AllowFiltering="false">
                                                <NumberFormat DecimalDigits="2" GroupSeparator="," />
                                                <EnabledStyle HorizontalAlign="Right" />
                                            </telerik:RadNumericTextBox>
                                        </ItemTemplate>
        ...
        <telerik:RadWindowManager ID="RadWindowManager1" VisibleStatusbar="false" runat="server">
            <Windows>
                <telerik:RadWindow ID="RadWindow1" VisibleStatusbar="false" runat="server" Style="z-index: 7001" BackColor="White" RenderMode="Lightweight" Skin="Bootstrap">
                </telerik:RadWindow>
            </Windows>
