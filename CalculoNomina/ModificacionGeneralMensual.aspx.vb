...
Public Class ModificacionGeneralMensual
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            If Not String.IsNullOrEmpty(Request("id")) Then
                ...
                grdEmpleadosMensual.MasterTableView.GetColumn("Comisiones").Display = False
                grdEmpleadosMensual.MasterTableView.GetColumn("Faltas").Display = False
                grdEmpleadosMensual.MasterTableView.GetColumn("HorasDobles").Display = False
                grdEmpleadosMensual.MasterTableView.GetColumn("HorasTriples").Display = False
                grdEmpleadosMensual.MasterTableView.GetColumn("PremioAsistencia").Display = False
                grdEmpleadosMensual.MasterTableView.GetColumn("PremioPuntualidad").Display = False
                grdEmpleadosMensual.MasterTableView.GetColumn("PrimaDominical").Display = False
            End If
        End If
    End Sub
    ...
    Private Sub CargarGridEmpleados()
        ...
        grdEmpleadosMensual.DataSource = cNomina.ConsultarDetalleNominaExtraordinaria()
    ...
    Private Sub cmbIncidencias_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbIncidencias.SelectedIndexChanged
        ...
        ElseIf cmbIncidencias.SelectedValue = 3 Then    'COMISION
            grdEmpleadosMensual.MasterTableView.GetColumn("Comisiones").Display = True
            grdEmpleadosMensual.MasterTableView.GetColumn("Faltas").Display = False
            grdEmpleadosMensual.MasterTableView.GetColumn("HorasDobles").Display = False
            grdEmpleadosMensual.MasterTableView.GetColumn("HorasTriples").Display = False
            grdEmpleadosMensual.MasterTableView.GetColumn("PremioAsistencia").Display = False
        ...
        ElseIf cmbIncidencias.SelectedValue = 6 Then    'HORAS DOBLES
            grdEmpleadosMensual.MasterTableView.GetColumn("Comisiones").Display = False
            grdEmpleadosMensual.MasterTableView.GetColumn("Faltas").Display = False
            grdEmpleadosMensual.MasterTableView.GetColumn("HorasDobles").Display = True
            grdEmpleadosMensual.MasterTableView.GetColumn("HorasTriples").Display = False
            grdEmpleadosMensual.MasterTableView.GetColumn("PremioAsistencia").Display = False
            grdEmpleadosMensual.MasterTableView.GetColumn("PremioPuntualidad").Display = False
            grdEmpleadosMensual.MasterTableView.GetColumn("PrimaDominical").Display = False
        ElseIf cmbIncidencias.SelectedValue = 7 Then    'HORAS TRIPLES
            ...
            grdEmpleadosMensual.MasterTableView.GetColumn("Faltas").Display = False
            grdEmpleadosMensual.MasterTableView.GetColumn("HorasDobles").Display = False
            grdEmpleadosMensual.MasterTableView.GetColumn("HorasTriples").Display = True
            grdEmpleadosMensual.MasterTableView.GetColumn("PremioAsistencia").Display = False
            grdEmpleadosMensual.MasterTableView.GetColumn("PremioPuntualidad").Display = False
            grdEmpleadosMensual.MasterTableView.GetColumn("PrimaDominical").Display = False
        ElseIf cmbIncidencias.SelectedValue = 13 Then    'PRIMA DOMINICAL
            ...
            grdEmpleadosMensual.MasterTableView.GetColumn("PremioAsistencia").Display = False
            grdEmpleadosMensual.MasterTableView.GetColumn("PremioPuntualidad").Display = False
            grdEmpleadosMensual.MasterTableView.GetColumn("PrimaDominical").Display = True
        ElseIf cmbIncidencias.SelectedValue = 23 Then    'PREMIO ASISTENCIA
            grdEmpleadosMensual.MasterTableView.GetColumn("Comisiones").Display = False
            grdEmpleadosMensual.MasterTableView.GetColumn("Faltas").Display = False
            grdEmpleadosMensual.MasterTableView.GetColumn("HorasDobles").Display = False
            grdEmpleadosMensual.MasterTableView.GetColumn("HorasTriples").Display = False
            grdEmpleadosMensual.MasterTableView.GetColumn("PremioAsistencia").Display = True
            grdEmpleadosMensual.MasterTableView.GetColumn("PremioPuntualidad").Display = False
            grdEmpleadosMensual.MasterTableView.GetColumn("PrimaDominical").Display = False
        ElseIf cmbIncidencias.SelectedValue = 24 Then    'PREMIO PUNTUALIDAD
            ...
            grdEmpleadosMensual.MasterTableView.GetColumn("HorasTriples").Display = False
            grdEmpleadosMensual.MasterTableView.GetColumn("PremioAsistencia").Display = False
            grdEmpleadosMensual.MasterTableView.GetColumn("PremioPuntualidad").Display = True
            grdEmpleadosMensual.MasterTableView.GetColumn("PrimaDominical").Display = False
        ElseIf cmbIncidencias.SelectedValue = 57 Then    'FALTAS
            grdEmpleadosMensual.MasterTableView.GetColumn("Comisiones").Display = False
            grdEmpleadosMensual.MasterTableView.GetColumn("Faltas").Display = True
            grdEmpleadosMensual.MasterTableView.GetColumn("HorasDobles").Display = False
            grdEmpleadosMensual.MasterTableView.GetColumn("HorasTriples").Display = False
            grdEmpleadosMensual.MasterTableView.GetColumn("PremioAsistencia").Display = False
            grdEmpleadosMensual.MasterTableView.GetColumn("PremioPuntualidad").Display = False
    ...
    Private Sub btnRegresar_Click(sender As Object, e As EventArgs) Handles btnRegresar.Click
        If Not String.IsNullOrEmpty(Request("id")) Then
            Response.Redirect("~/GeneracionDeNominaMensualNormal.aspx?id=" & periodoId.Value.ToString, False)
        Else
            Response.Redirect("~/GeneracionDeNominaMensualNormal.aspx", False)
        End If
    End Sub
