            ...
            <table style="width: 100%;" border="0">
                ...
                <tr style="height: 30px;">
                    <td style="width: 20%;" align="left">
                        <telerik:RadButton ID="btnAceptar" RenderMode="Lightweight" Text="Aceptar" Width="100px" runat="server">
                        </telerik:RadButton>
                    </td>
                    <td align="left" colspan="4">
                        <telerik:RadButton ID="btnCancelar" RenderMode="Lightweight" Text="Cancelar" Width="100px" runat="server">
                        </telerik:RadButton>
                    </td>
                </tr>
            </table>
            ...
            <div class="col-md-12" style="border: solid 0px;">
                <table style="width: 90%" border="0">
                    ...
                    <tr style="height: 30px;">
                        ...
                        <td style="width: 15%;">
                            <telerik:RadButton ID="btnAgregar" RenderMode="Lightweight" runat="server" Width="140px" Text="Agregar Concepto"></telerik:RadButton>
                        </td>
                    </tr>
                    <tr style="height: 30px;">
                        <td style="width: 10%;">
                    ...
                    <tr style="height: 50px;">
                        <td style="text-align: right; height:50px;">
                            <telerik:RadButton ID="btnRegresar" RenderMode="Lightweight" runat="server" Width="130px" Text="Regresar"></telerik:RadButton>
                        </td>
                        <td style="text-align: right; width: 15%; height:50px;">
                            <telerik:RadButton ID="btnGenerarFiniquito" RenderMode="Lightweight" runat="server" Width="150px" Text="Generar Finiquito"></telerik:RadButton>
                        </td>
                        <td style="text-align: right; width: 15%; height:50px;">
                            <telerik:RadButton ID="btnDescargarPDFFiniquito" RenderMode="Lightweight" runat="server" Visible="false" Width="140px" Text="Descargar Finiquito"></telerik:RadButton>
                        </td>
                        <td style="text-align: right; width: 15%; height:50px;">
                            <telerik:RadButton ID="btnDescargarPDFRenuncia" RenderMode="Lightweight" runat="server" Visible="false" Width="160px" Text="Descargar Renuncia"></telerik:RadButton>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr style="height: 50px;">
