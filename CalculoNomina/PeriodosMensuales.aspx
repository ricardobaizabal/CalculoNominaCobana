<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="PeriodosMensuales.aspx.vb" Inherits="CalculoNomina.PeriodosMensuales" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" HorizontalAlign="NotSet" LoadingPanelID="RadAjaxLoadingPanel1">
        <div class="ibox-content" style="border: solid 0px">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="m-t-none m-b">Periodos Mensuales</h1>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <table style="width: 100%;" border="0">
                        ...
                        <tr>
                            <td colspan="3">
                                <telerik:RadGrid ID="GridPeriodosMensuales" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="100" Width="100%"
