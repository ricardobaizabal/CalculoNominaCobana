<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GeneracionDeNominaQuincenalNormal.aspx.vb" MasterPageFile="~/MasterPage.Master" Inherits="CalculoNomina.GeneracionDeNominaQuincenalNormal" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" HorizontalAlign="NotSet" LoadingPanelID="RadAjaxLoadingPanel1" ClientEvents-OnRequestStart="OnRequestStart">
        ...
        <div class="ibox-content" style="border: solid 0px">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="m-t-none m-b">Generación de nómina ordinaria quincenal</h1>
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-2 col-sm-2">
                    <div class="form-group">
                        <telerik:RadButton ID="btnTimbrarNominaQuincenal" RenderMode="Lightweight" Enabled="false" runat="server" Width="141px" Height="50px">
    ...
    <telerik:RadAjaxLoadingPanel runat="server" ID="RadAjaxLoadingPanel3" Skin="Bootstrap" Width="100%">
    </telerik:RadAjaxLoadingPanel>
</asp:Content>
