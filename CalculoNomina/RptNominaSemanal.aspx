                    ...
                    <telerik:RadGrid ID="gridReporte" runat="server" AutoGenerateColumns="False" ShowHeader="true" AllowPaging="false" ShowFooter="true" CellSpacing="0" GridLines="None" Skin="Bootstrap">
                        ...
                        <MasterTableView NoMasterRecordsText="No hay registros para mostrar." CommandItemDisplay="Top">
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="IntegradoIMSS" DataFormatString="{0:C}" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Right" HeaderText="Integrado IMSS" UniqueName="IntegradoIMSS" Aggregate="Sum" FooterStyle-Font-Bold="true" FooterStyle-HorizontalAlign="Right">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="TotalPercepciones" DataFormatString="{0:C}" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Right" HeaderText="Percepciones" UniqueName="TotalPercepciones" Aggregate="Sum" FooterStyle-Font-Bold="true" FooterStyle-HorizontalAlign="Right">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="TotalDucciones" DataFormatString="{0:C}" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Right" HeaderText="Deducciones" UniqueName="TotalDucciones" Aggregate="Sum" FooterStyle-Font-Bold="true" FooterStyle-HorizontalAlign="Right">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="Neto" DataFormatString="{0:C}" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Right" HeaderText="Total a pagar" UniqueName="Neto" Aggregate="Sum" FooterStyle-Font-Bold="true" FooterStyle-HorizontalAlign="Right">
                                </telerik:GridBoundColumn>
                            </Columns>
                        </MasterTableView>
                    </telerik:RadGrid>
