...
Namespace FactureHoyNTPruebas
    ...
    Partial Public Class WsEmisionTimbradoService
        ...
        Private CancelarEncodeCSDRevocadoOperationCompleted As System.Threading.SendOrPostCallback
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.CalculoNomina.My.MySettings.Default.CalculoNomina_FactureHoyNTPruebas_WsEmisionTimbradoService
        ...
        '''<remarks/>
        Public Event CancelarEncodeCSDRevocadoCompleted As CancelarEncodeCSDRevocadoCompletedEventHandler
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("", RequestNamespace:="http://cfdi.ws2.facturehoy.certus.com/", ResponseNamespace:="http://cfdi.ws2.facturehoy.certus.com/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function CancelarEncodeCSDRevocado(<System.Xml.Serialization.XmlElementAttribute(Form:=System.Xml.Schema.XmlSchemaForm.Unqualified)> ByVal usuario As String, <System.Xml.Serialization.XmlElementAttribute(Form:=System.Xml.Schema.XmlSchemaForm.Unqualified)> ByVal contrasenia As String, <System.Xml.Serialization.XmlElementAttribute("UUID", Form:=System.Xml.Schema.XmlSchemaForm.Unqualified, IsNullable:=true)> ByVal UUID() As String, <System.Xml.Serialization.XmlElementAttribute(Form:=System.Xml.Schema.XmlSchemaForm.Unqualified)> ByVal keyEncode As String, <System.Xml.Serialization.XmlElementAttribute(Form:=System.Xml.Schema.XmlSchemaForm.Unqualified, DataType:="base64Binary", IsNullable:=true)> ByVal certificado() As Byte) As <System.Xml.Serialization.XmlElementAttribute("return", Form:=System.Xml.Schema.XmlSchemaForm.Unqualified)> wsResponseCancelaBO
            Dim results() As Object = Me.Invoke("CancelarEncodeCSDRevocado", New Object() {usuario, contrasenia, UUID, keyEncode, certificado})
            Return CType(results(0),wsResponseCancelaBO)
        End Function
        
        '''<remarks/>
        Public Overloads Sub CancelarEncodeCSDRevocadoAsync(ByVal usuario As String, ByVal contrasenia As String, ByVal UUID() As String, ByVal keyEncode As String, ByVal certificado() As Byte)
            Me.CancelarEncodeCSDRevocadoAsync(usuario, contrasenia, UUID, keyEncode, certificado, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub CancelarEncodeCSDRevocadoAsync(ByVal usuario As String, ByVal contrasenia As String, ByVal UUID() As String, ByVal keyEncode As String, ByVal certificado() As Byte, ByVal userState As Object)
            If (Me.CancelarEncodeCSDRevocadoOperationCompleted Is Nothing) Then
                Me.CancelarEncodeCSDRevocadoOperationCompleted = AddressOf Me.OnCancelarEncodeCSDRevocadoOperationCompleted
            End If
            Me.InvokeAsync("CancelarEncodeCSDRevocado", New Object() {usuario, contrasenia, UUID, keyEncode, certificado}, Me.CancelarEncodeCSDRevocadoOperationCompleted, userState)
        End Sub
        
        Private Sub OnCancelarEncodeCSDRevocadoOperationCompleted(ByVal arg As Object)
            If (Not (Me.CancelarEncodeCSDRevocadoCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent CancelarEncodeCSDRevocadoCompleted(Me, New CancelarEncodeCSDRevocadoCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Xml", "4.6.1055.0"),  _
     ...
     System.ComponentModel.DesignerCategoryAttribute("code"),  _
     System.Xml.Serialization.XmlTypeAttribute([Namespace]:="http://cfdi.ws2.facturehoy.certus.com/")>  _
    Partial Public Class wsResponseCancelaBO
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1055.0")>  _
    Public Delegate Sub CancelarEncodeCSDRevocadoCompletedEventHandler(ByVal sender As Object, ByVal e As CancelarEncodeCSDRevocadoCompletedEventArgs)
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1055.0"),  _
     System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code")>  _
    Partial Public Class CancelarEncodeCSDRevocadoCompletedEventArgs
        Inherits System.ComponentModel.AsyncCompletedEventArgs
        ...
        '''<remarks/>
        Public ReadOnly Property Result() As wsResponseCancelaBO
            Get
                Me.RaiseExceptionIfNecessary
                Return CType(Me.results(0),wsResponseCancelaBO)
            End Get
        End Property
    End Class
End Namespace
