            ...
            If ds.Tables(0).Rows.Count > 0 Then
                For Each row As DataRow In ds.Tables(0).Rows
                    ...
                    ElseIf row("error") = 0 Then
                        ...
                        Session("conexion") = "Data Source=" & System.Configuration.ConfigurationManager.AppSettings("server").ToString & "; Initial Catalog=" & row("appKey") & "; User ID=sa; Password=L1nkium12*; Max Pool Size=360;"
