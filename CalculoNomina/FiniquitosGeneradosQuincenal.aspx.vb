...
Public Class FiniquitosGeneradosQuincenal
        ...
        If cmbPeriodo.SelectedValue > 0 Then
            ...
            If dt.Rows.Count > 0 Then
                ...
                For Each oDataRow In dt.Rows
                    ...
                    rutaEmpresa = Server.MapPath("~/XmlGenerados/").ToString & RfcEmisor.ToString & "/" & RfcCliente.ToString & "/Q/" & IdEjercicio.ToString & "/F/" & cmbPeriodo.SelectedValue.ToString
    ...
    Private Function Descomprimir(ByVal data5 As Byte(), ByVal NoEmpleado As Integer, ByVal RFC As String, ByVal IdCliente As Integer)
        ...
        DirectorioExtraccion = Server.MapPath("~/XmlTimbrados/" & RfcEmisor & "/" & RfcCliente.ToString & "/Q/").ToString & IdEjercicio.ToString & "/F/" & cmbPeriodo.SelectedValue.ToString & "/"
        ...
        If File.Exists(DirectorioExtraccion & archivo) Then
            ...
            If File.Exists(FolioXml) Then
                ...
                File.Delete(Server.MapPath("~/XmlGenerados/").ToString & RfcEmisor.ToString & "/" & RfcCliente.ToString & "/Q/" & IdEjercicio.ToString & "/F/" & cmbPeriodo.SelectedValue.ToString & "/" & serie.Value.ToString & folio.Value.ToString & ".xml")
            End If
    ...
    Private Sub DownloadXML(ByVal NoEmpleado As Integer, ByVal RFC As String, ByVal UUID As String, ByVal IdCliente As Integer)
        ...
        Dim rutaEmpresa As String = ""
        rutaEmpresa = Server.MapPath("~/XmlTimbrados/" & RfcEmisor & "/" & RfcCliente.ToString & "/Q/").ToString & IdEjercicio.ToString & "/F/" & cmbPeriodo.SelectedValue.ToString & "/"
    ...
    Private Sub grdEmpleados_ItemCommand(sender As Object, e As GridCommandEventArgs) Handles grdEmpleados.ItemCommand
        Select Case e.CommandName
            ...
            Case "cmdFiniquito"
                ...
                Dim FilePath = Server.MapPath("~/PDF/").ToString & RfcEmisor.ToString & "/" & RfcCliente.ToString & "/Q/" & IdEjercicio.ToString & "/F/" & cmbPeriodo.SelectedValue.ToString & "/" & "F" & String.Format("{0:00}", NoEmpleado) & ".pdf"
            ...
            Case "cmdRenuncia"
                ...
                Dim FilePath = Server.MapPath("~/PDF/").ToString & RfcEmisor.ToString & "/" & RfcCliente.ToString & "/Q/" & IdEjercicio.ToString & "/F/" & cmbPeriodo.SelectedValue.ToString & "/" & "R" & String.Format("{0:00}", NoEmpleado) & ".pdf"
    ...
    Private Sub DownloadPDFTimbrado(ByVal NoEmpleado As Integer, ByVal RFC As String, ByVal UUID As String, ByVal IdCliente As Integer)
        ...
        Dim rutaEmpresa As String = ""
        rutaEmpresa = Server.MapPath("~/PDF/").ToString & RfcEmisor.ToString & "/" & RfcCliente.ToString & "/Q/" & IdEjercicio.ToString & "/F/" & cmbPeriodo.SelectedValue.ToString
        ...
        If cmbPeriodo.SelectedValue > 0 Then
            ...
            If dt.Rows.Count > 0 Then
                ...
                For Each row In dt.Rows
                    ...
                    rutaEmpresa = Server.MapPath("~/PDF/" & RfcEmisor & "/" & RfcCliente.ToString & "/Q/").ToString & IdEjercicio.ToString & "/F/" & cmbPeriodo.SelectedValue.ToString & "/"
