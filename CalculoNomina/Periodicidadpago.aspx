<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="Periodicidadpago.aspx.vb" Inherits="CalculoNomina.Periodicidadpago" %>
...
<%--        <div class="col-sm-6 b-r">
            <h1 class="m-t-none m-b">Periodicidad de pago</h1>
        ...
        <div class="col-lg-12 b-r">
            <br />
            <br />
            <h3 class="m-t-none m-b">Periodicidad de Pago</h3>
            <hr class="demo-separator" />
            <br />
            <telerik:RadGrid ID="GridPeriodicidadpago" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="50"
