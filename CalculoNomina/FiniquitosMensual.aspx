<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="FiniquitosMensual.aspx.vb" Inherits="CalculoNomina.FiniquitosMensual" %>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <fieldset>
                            <legend style="padding-right: 6px; color: Black">
                                <asp:Label ID="tblTitulo" Text="Generación de finiquitos mensual" runat="server" Font-Bold="True" CssClass="item"></asp:Label>
                            </legend>
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <telerik:RadGrid ID="grdEmpleadosMensual" runat="server" AutoGenerateColumns="False" AllowPaging="True" AllowSorting="True" ShowFooter="True" ShowHeader="True" PageSize="50" CellSpacing="0" GridLines="None" Skin="Bootstrap" ExportSettings-ExportOnlyData="False">
                                        ...
                                        <ExportSettings IgnorePaging="True" FileName="ReporteBajasMensual">
                                            <Excel Format="Biff" />
                                        </ExportSettings>
