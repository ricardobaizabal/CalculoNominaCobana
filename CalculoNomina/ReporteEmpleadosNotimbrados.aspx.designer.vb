...
Partial Public Class ReporteEmpleadosNotimbrados
    ...
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents btnBuscarEmpleados As Global.Telerik.Web.UI.RadButton
    ...
    '''<summary>
    '''Control GridEmpleadosNoTimbrados.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents GridEmpleadosNoTimbrados As Global.Telerik.Web.UI.RadGrid
