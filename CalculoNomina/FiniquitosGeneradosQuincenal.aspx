<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="FiniquitosGeneradosQuincenal.aspx.vb" Inherits="CalculoNomina.FiniquitosGeneradosQuincenal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function OpenWindow(empresaid, ejercicioid, tiponomina) {
            ...
            oWnd.set_title("Reporte Nómina Quincenal Extraordinaria - Finiquitos")
            oWnd.center();
            oWnd.show();
        }
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="ibox-content" style="border: solid 0px">
        <div class="row">
            <div class="col-md-12">
                <h1 class="m-t-none m-b">Finiquitos generados nómina quincenal</h1>
