...
Public Class ResumenNominaCatorcenal
    ...
    Private Sub GenerarPDF()
        ...
        ' Agregar un título
        Dim titulo As New Paragraph("RESUMEN DE NÓMINA CATORCENAL", FontFactory.GetFont(FontFactory.HELVETICA_BOLD, 12, New BaseColor(39, 17, 149)))
