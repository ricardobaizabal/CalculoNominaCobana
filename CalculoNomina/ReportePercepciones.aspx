<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="ReportePercepciones.aspx.vb" Inherits="CalculoNomina.ReportePercepciones" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function OnRequestStart(target, arguments) {
            if ((arguments.get_eventTarget().indexOf("grdPercepciones") > -1)) {
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <h3 class="item-title">Reporte Percepciones</h3>
    </div>
    <div>
        <telerik:RadGrid ID="grdPercepciones" runat="server" AutoGenerateColumns="False" AllowPaging="True" ShowFooter="True" PageSize="50" CellSpacing="0" ExportSettings-ExportOnlyData="true" GridLines="None" Skin="Office2010Silver">
