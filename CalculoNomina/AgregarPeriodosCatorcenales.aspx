<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="AgregarPeriodosCatorcenales.aspx.vb" Inherits="CalculoNomina.AgregarPeriodosCatorcenales" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="ibox-content">
        ...
        <br />
        <h3 class="m-t-none m-b">Generación de Periodos Catorcenales</h3>
