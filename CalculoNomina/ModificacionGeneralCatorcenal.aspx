                            ...
                            <MasterTableView AllowMultiColumnSorting="true" AllowFilteringByColumn="true" NoMasterRecordsText="No hay registros para mostrar." DataKeyNames="NoEmpleado, IdContrato, CuotaDiaria, IntegradoIMSS, IdContrato, idNomina">
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn UniqueName="Faltas" AllowFiltering="false">
                                        ...
                                        <ItemTemplate>
                                            <telerik:RadNumericTextBox ID="txtFaltas" runat="server" MinValue="0" Value="0" Type="Number" NumberFormat-DecimalDigits="2" OnTextChanged="txtFaltas_TextChanged" AutoPostBack="true" Text='<%# Eval("Faltas") %>' Skin="Default" Width="80px" TabIndex="1" MaxValue="14" MaxLength="2" AllowFiltering="false">
                                    ...
                                    <telerik:GridTemplateColumn UniqueName="IncapacidadEG" AllowFiltering="false">
                                        ...
                                        <ItemTemplate>
                                            <telerik:RadNumericTextBox ID="txtIncapacidadEG" runat="server" MinValue="0" Value="0" Type="Number" NumberFormat-DecimalDigits="2" OnTextChanged="txtIncapacidadEG_TextChanged" AutoPostBack="true" Text='<%# Eval("IncapacidadEG") %>' Skin="Default" Width="80px" TabIndex="2" MaxValue="14" MaxLength="2" AllowFiltering="false">
                                                <NumberFormat DecimalDigits="2" GroupSeparator="," />
                                                <EnabledStyle HorizontalAlign="Right" />
                                            </telerik:RadNumericTextBox>
                                        </ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn UniqueName="IncapacidadRT" AllowFiltering="false">
                                        ...
                                        <ItemTemplate>
                                            <telerik:RadNumericTextBox ID="txtIncapacidadRT" runat="server" MinValue="0" Value="0" Type="Number" NumberFormat-DecimalDigits="2" OnTextChanged="txtIncapacidadRT_TextChanged" AutoPostBack="true" Text='<%# Eval("IncapacidadRT") %>' Skin="Default" Width="80px" TabIndex="3" MaxValue="14" MaxLength="2" AllowFiltering="false">
                                                <NumberFormat DecimalDigits="2" GroupSeparator="," />
                                                <EnabledStyle HorizontalAlign="Right" />
                                            </telerik:RadNumericTextBox>
                                        </ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn UniqueName="IncapacidadMaterna" AllowFiltering="false">
                                        ...
                                        <ItemTemplate>
                                            <telerik:RadNumericTextBox ID="txtIncapacidadMaterna" runat="server" MinValue="0" Value="0" Type="Number" NumberFormat-DecimalDigits="2" OnTextChanged="IncapacidadMaterna_TextChanged" AutoPostBack="true" Text='<%# Eval("IncapacidadMaterna") %>' Skin="Default" Width="80px" TabIndex="4" MaxValue="14" MaxLength="2" AllowFiltering="false">
                                                <NumberFormat DecimalDigits="2" GroupSeparator="," />
                                                <EnabledStyle HorizontalAlign="Right" />
                                            </telerik:RadNumericTextBox>
                                        </ItemTemplate>
