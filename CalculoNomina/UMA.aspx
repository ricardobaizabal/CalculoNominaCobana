<%@ Page Language="vb" MasterPageFile="~/MasterPage.Master" AutoEventWireup="false" CodeBehind="UMA.aspx.vb" Inherits="CalculoNomina.UMA" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    ...
    <style type="text/css">
        ...
        #ctl00_ContentPlaceHolder1_grdUMA {
                ...
                <table style="width: 100%;" border="0">
                    <tr>
                        <td>
                            <br />
                            <br />
                            <h3 class="m-t-none m-b">UMA - Unidad de Medida y Actualización</h3>
                            <hr class="demo-separator" />
                            <br />
                            <telerik:RadGrid ID="grdUMA" runat="server" AutoGenerateColumns="False" AllowPaging="false" PageSize="10" Width="90%"
                                ...
                                <MasterTableView AllowMultiColumnSorting="true" AllowSorting="true" DataKeyNames="id" NoMasterRecordsText="No hay registros para mostrar." Name="UMA" Width="100%">
                                    <Columns>
