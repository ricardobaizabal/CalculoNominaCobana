...
Public Class IncidenciasMensual
        ...
        If Not IsPostBack Then
            ...
            If Not String.IsNullOrEmpty(Request("id")) And Not String.IsNullOrEmpty(Request("empleadoid")) Then
                ...
                If cPeriodo.IdPeriodo > 0 Then
                    lblFechaInicial.Text = Format(CDate(cPeriodo.FechaInicial), "dd/MM/yyyy")
                    lblFechaFinal.Text = Format(CDate(cPeriodo.FechaFinal), "dd/MM/yyyy")
                End If
    ...
    Private Sub GridPercepciones_NeedDataSource(sender As Object, e As GridNeedDataSourceEventArgs) Handles GridPercepciones.NeedDataSource
        ...
        If dt.Rows.Count > 0 Then
            ...
            'Dim OtrosPagos As Decimal = dt.Compute("Sum(Importe)", "CvoConcepto=54")
            'txtPercepciones.Text = Math.Round(dt.Compute("Sum(Importe)", "") - OtrosPagos, 6)
            'txtOtrosPagos.Text = Math.Round(OtrosPagos, 6)
        End If
    End Sub
    ...
    Private Sub EliminarConcepto(ByVal NumeroConcepto As Int32, ByVal TipoHorasExtra As String)
        ...
        Try
            CuotaDiaria = Convert.ToDecimal(Replace(lblCuotaDiaria.Text, "$", ""))
        Catch ex As Exception
            CuotaDiaria = 0
        End Try
        Try
            SalarioDiarioIntegradoTrabajador = Convert.ToDecimal(lblIntegradoImss.Text)
        Catch ex As Exception
            SalarioDiarioIntegradoTrabajador = 0
        End Try
    ...
    Private Sub CalcularImpuesto()
        ...
        Dim DiasTarifaISR As Decimal = 30
    ...
    Private Sub btnEliminarConcepto_Click(sender As Object, e As EventArgs) Handles btnEliminarConcepto.Click
        Call EliminarConcepto(conceptoId.Value, tipohorasextraId.Value)
    End Sub
    Private Sub txtDias_TextChanged(sender As Object, e As EventArgs) Handles txtDias.TextChanged
        ...
        Else
            ...
            Try
                SalarioDiarioIntegradoTrabajador = Convert.ToDecimal(Replace(lblIntegradoImss.Text, "$", ""))
            Catch ex As Exception
                SalarioDiarioIntegradoTrabajador = 0
            End Try
    ...
    '                If (Impuesto > 0 And (Impuesto < (SubsidioDiario * 7))) Then
    '                    SubsidioAplicado = Impuesto
    '                Else
    '                    SubsidioAplicado = (SubsidioDiario * 7)
    '                End If
    ...
    Private Sub GridOtrosPagos_ItemDataBound(sender As Object, e As GridItemEventArgs) Handles GridOtrosPagos.ItemDataBound
        ...
        End Select
    End Sub
    'Protected Sub txtIntegradoImss_TextChanged(sender As Object, e As EventArgs)
    '    Try
    '        CuotaDiaria = Convert.ToDecimal(Replace(lblCuotaDiaria.Text, "$", ""))
    '    Catch ex As Exception
    '        CuotaDiaria = 0
    ...
    '            Call ChecarPercepcionesGravadas(empleadoId.Value, 56) 'CUOTA IMSS
    '            Call ChecarYGrabarPercepcionesExentasYGravadas(empleadoId.Value, 0)
    ...
    Private Sub btnCerrar_Click(sender As Object, e As EventArgs) Handles btnCerrar.Click
        Dim pagina = "ModificacionGeneralMensual.aspx"
