...
Partial Public Class AltaMasivaEmpleados

    '''<summary>
    '''Control panelListaEmpleados.
    '''</summary>
    '''<remarks>
    ...
    '''<summary>
    '''Control lblEmpleadosSuccess.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents lblEmpleadosSuccess As Global.System.Web.UI.WebControls.Label
    ...
    '''<summary>
    '''Control lblEmpleadosError.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents lblEmpleadosError As Global.System.Web.UI.WebControls.Label
    ...
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents litErrores As Global.System.Web.UI.WebControls.Literal

    '''<summary>
    '''Control panelErroresCatalogos.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents panelErroresCatalogos As Global.System.Web.UI.WebControls.Panel

    '''<summary>
    '''Control lblEmpleadosErrorCatalogos.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents lblEmpleadosErrorCatalogos As Global.System.Web.UI.WebControls.Label

    '''<summary>
    '''Control litErroresCatalogo.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    ...
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents Mensaje_Resultado As Global.System.Web.UI.WebControls.Label
    ...
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents GridErrors As Global.Telerik.Web.UI.RadGrid
