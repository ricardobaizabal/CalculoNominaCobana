...
Public Class FiniquitosGeneradosMensual
    ...
    Private Sub btnConfirmarGeneraNominaElectronica_Click(sender As Object, e As EventArgs) Handles btnConfirmarGeneraNominaElectronica.Click
        ...
        If dt.Rows.Count > 0 Then
            ...
            For Each oDataRow In dt.Rows
                ...
                rutaEmpresa = Server.MapPath("~/XmlGenerados/").ToString & RfcEmisor.ToString & "/" & RfcCliente.ToString & "/M/" & IdEjercicio.ToString & "/F/" & cmbPeriodo.SelectedValue.ToString
    ...
    Private Function Descomprimir(ByVal data5 As Byte(), ByVal NoEmpleado As Integer, ByVal RFC As String, ByVal IdCliente As Integer)
        ...
        DirectorioExtraccion = Server.MapPath("~/XmlTimbrados/" & RfcEmisor & "/" & RfcCliente.ToString & "/M/").ToString & IdEjercicio.ToString & "/F/" & cmbPeriodo.SelectedValue.ToString & "/"
        ...
        If File.Exists(DirectorioExtraccion & archivo) Then
            ...
            If File.Exists(FolioXml) Then
                ...
                File.Delete(Server.MapPath("~/XmlGenerados/").ToString & RfcEmisor.ToString & "/" & RfcCliente.ToString & "/M/" & IdEjercicio.ToString & "/F/" & cmbPeriodo.SelectedValue.ToString & "/" & serie.Value.ToString & folio.Value.ToString & ".xml")
            End If
    ...
    Private Sub grdEmpleados_ItemCommand(sender As Object, e As GridCommandEventArgs) Handles grdEmpleados.ItemCommand
        Select Case e.CommandName
            ...
            Case "cmdFiniquito"
                ...
                Dim DirectorioExtraccion As String = ""
                DirectorioExtraccion = Server.MapPath("~/PDF/").ToString & RfcEmisor.ToString & "/" & RfcCliente.ToString & "/M/" & IdEjercicio.ToString & "/F/" & cmbPeriodo.SelectedValue.ToString

                If Not Directory.Exists(DirectorioExtraccion) Then
                    Directory.CreateDirectory(DirectorioExtraccion)
                End If

                Dim FilePath = Server.MapPath("~/PDF/").ToString & RfcEmisor.ToString & "/" & RfcCliente.ToString & "/M/" & IdEjercicio.ToString & "/F/" & cmbPeriodo.SelectedValue.ToString & "/" & "F" & String.Format("{0:00}", NoEmpleado) & ".pdf"
            ...
            Case "cmdRenuncia"
                ...
                Dim FilePath = Server.MapPath("~/PDF/").ToString & RfcEmisor.ToString & "/" & RfcCliente.ToString & "/M/" & IdEjercicio.ToString & "/F/" & cmbPeriodo.SelectedValue.ToString & "/" & "R" & String.Format("{0:00}", NoEmpleado) & ".pdf"
    ...
    Private Sub DownloadPDFTimbrado(ByVal NoEmpleado As Integer, ByVal RFC As String, ByVal UUID As String, ByVal IdCliente As Integer)
        ...
        Dim rutaEmpresa As String = ""
        rutaEmpresa = Server.MapPath("~/PDF/").ToString & RfcEmisor.ToString & "/" & RfcCliente.ToString & "/M/" & IdEjercicio.ToString & "/F/" & cmbPeriodo.SelectedValue.ToString
    ...
    Private Sub DownloadXML(ByVal NoEmpleado As Integer, ByVal RFC As String, ByVal UUID As String, ByVal IdCliente As Integer)
        ...
        Dim rutaEmpresa As String = ""
        rutaEmpresa = Server.MapPath("~/XmlTimbrados/" & RfcEmisor & "/" & RfcCliente.ToString & "/M/").ToString & IdEjercicio.ToString & "/F/" & cmbPeriodo.SelectedValue.ToString & "/"
        ...
        If dt.Rows.Count > 0 Then
            For Each row As DataRow In dt.Rows
                Try
                    ...
                    Dim FilePath = Server.MapPath("~/CBB/M/F/" & UUID.ToString & ".png")
                    If Not File.Exists(FilePath) Then
                        CodigoBidimensional(FolioXml)
                    End If

                    reporte.ReportParameters("paramImgCBB").Value = Server.MapPath("~/CBB/M/F/" & UUID.ToString & ".png")
    ...
    Private Sub CodigoBidimensional(ByVal RutaXml As String)
        ...
        If Not Directory.Exists(Server.MapPath("~/CBB/M/F/")) Then
            Directory.CreateDirectory(Server.MapPath("~/CBB/M/F/"))
        End If
        ...
        CBidimensional.Save(Server.MapPath("~/CBB/M/F/") & UUID & ".png", System.Drawing.Imaging.ImageFormat.Png)
    End Sub
        ...
        If cmbPeriodo.SelectedValue > 0 Then
            ...
            If dt.Rows.Count > 0 Then
                ...
                For Each row In dt.Rows
                    ...
                    rutaEmpresa = Server.MapPath("~/PDF/" & RfcEmisor & "/" & RfcCliente.ToString & "/M/").ToString & IdEjercicio.ToString & "/F/" & cmbPeriodo.SelectedValue.ToString & "/"
