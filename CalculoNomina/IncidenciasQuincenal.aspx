<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="IncidenciasQuincenal.aspx.vb" Inherits="CalculoNomina.IncidenciasQuincenal" %>
            ...
            <div class="ibox-content" style="border: solid 0px; height: 585px;">
                    ...
                    <fieldset>
                        <table style="width: 100%" border="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <telerik:RadNumericTextBox ID="txtDias" runat="server" Value="0" MinValue="1" MaxValue="15" NumberFormat-DecimalDigits="2" Width="90px" AutoPostBack="true">
                ...
                <div class="row">
                    <div class="col-md-6" style="border: solid 0px;">
                        <label class="control-label" style="color: #000;">P E R C E P C I O N E S</label>
