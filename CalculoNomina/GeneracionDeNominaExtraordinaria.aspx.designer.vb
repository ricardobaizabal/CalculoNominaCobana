...
Partial Public Class GeneracionDeNominaExtraordinaria
    ...
    '''<summary>
    '''Control btnTimbrarNominaSemanal.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    ...
    '''<summary>
    '''Control WinImportarMontoIndividual.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents WinImportarMontoIndividual As Global.Telerik.Web.UI.RadWindow
    ...
    '''<summary>
    '''Control btnImportarIndividual.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents btnImportarIndividual As Global.Telerik.Web.UI.RadButton

    '''<summary>
    '''Control btnCancelarIndividual.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents btnCancelarIndividual As Global.Telerik.Web.UI.RadButton
End Class
