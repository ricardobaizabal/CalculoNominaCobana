<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="RegimenContratacion.aspx.vb" Inherits="CalculoNomina.RegimenContratacion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" HorizontalAlign="NotSet" LoadingPanelID="RadAjaxLoadingPanel1">
        <div class="col-lg-12 b-r">
            <br />
            <br />
            <h3 class="m-t-none m-b">Régimen Contratación</h3>
            <hr class="demo-separator" />
            <br />
            <telerik:RadGrid ID="GridRegimen" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="50"
