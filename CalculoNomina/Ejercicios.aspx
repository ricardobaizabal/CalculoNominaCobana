        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="form-group">
                    ...
                    <div class="col-lg-2">
                        <telerik:RadNumericTextBox ID="txtEjercicio" runat="server" MinValue="0" Width="100px">
                            <NumberFormat GroupSeparator="" DecimalDigits="0" AllowRounding="true" KeepNotRoundedValue="false" />
                        </telerik:RadNumericTextBox>
                    </div>
                    <div class="col-lg-3">
                        <telerik:RadButton ID="btnSave" runat="server" Skin="Bootstrap" CssClass="rbPrimaryButton" Text="Guadar Ejercicio"></telerik:RadButton>
                    </div>
            ...
            <div class="col-lg-12">
                <div class="form-group">
                    <div class="col-md-12">
                        <br />
                        <br />
                        <h3 class="m-t-none m-b">Listado de Ejercicios</h3>
                        ...
                        <telerik:RadGrid ID="GridEjercicio" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="50"
                            ...
                            <MasterTableView DataKeyNames="id" NoMasterRecordsText="No hay registros para mostrar.">
                                ...
                                <Columns>
                                    <telerik:GridTemplateColumn UniqueName="CheckBoxTemplateColumn" ItemStyle-Width="90px" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Año" DataField="annio" SortExpression="annio" UniqueName="annio">
                                        <ItemTemplate>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <div class="col-lg-12" style="text-align: right;">
                        <telerik:RadButton ID="btnModificarEjercicio" RenderMode="Lightweight" runat="server" Skin="Bootstrap" CssClass="rbPrimaryButton" Text="Guadar Activo" Width="120px"></telerik:RadButton>
                    </div>
                </div>
            </div>
        </div>
