    ...
    <div class="ibox-content" style="border: solid 0px">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-sm-12 b-r">
                <h1 class="m-t-none m-b">Listado de nómina normal mensual</h1>
                    ...
                    <div class="form-group">
                        <table style="width: 100%;border-collapse: separate;border-spacing: 10px;">
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="cmbCliente" runat="server" Width="300px"></asp:DropDownList>
                             ...
                             <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="cmbPeriodicidad" AutoPostBack="true" runat="server" Width="300px"></asp:DropDownList>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                     <asp:Button ID="btnBuscarNominas" runat="server" Text="Buscar Nóminas" CssClass="rbPrimaryButton" CausesValidation="False" />
                                </td>
                            </tr>
                        </table>
                    </div>
        ...
        <asp:Panel runat="server" ID="panelDatos" Visible="True">
            ...
            <fieldset>
                <div class="form-group row">
                    <telerik:RadGrid ID="GridNominas" runat="server" AutoGenerateColumns="False" AllowPaging="True" AllowSorting="True" ShowFooter="False" ShowHeader="True" PageSize="10" CellSpacing="0" GridLines="None" Skin="Simple" ExportSettings-ExportOnlyData="False" >
        ...
        <asp:Button ID="btnAgregarNominaE" runat="server" Text="Agregar Nómina" CssClass="rbPrimaryButton" CausesValidation="False" />
    </div>
