...
Public Class GeneracionDeNominaCatorcenal
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            Else
                LlenaComboPeriodosCatorcenal(0)
            End If
    ...
    Protected Sub btnRegresar_Click(sender As Object, e As EventArgs) Handles btnRegresar.Click
        Response.Redirect("ListadoNominaNormalCatorcenal.aspx")
    End Sub
    ...
    Private Sub btnGeneraNomina_Click(sender As Object, e As EventArgs) Handles btnGeneraNomina.Click
        If cmbPeriodo.SelectedValue > 0 Then
            rwConfirmGeneraNomina.RadConfirm("¿Está seguro de generar el cálculo de nómina sin incidencias?", "confirmCallbackFnGenerarNomina", 330, 180, Nothing, "Confirmar")
    ...
    Private Sub btnCrearPeriodoID_Click(sender As Object, e As EventArgs) Handles btnCrearPeriodoID.Click
        ...
        Else
            ...
            fchFinPeriodo.SelectedDate = DateTime.Now.AddDays(14)
        End If
    End Sub
    Private Sub btnModificacionDeNomina_Click(sender As Object, e As EventArgs) Handles btnModificacionDeNomina.Click
        If cmbPeriodo.SelectedValue > 0 Then
            Response.Redirect("~/ModificacionGeneralCatorcenal.aspx?id=" & cmbPeriodo.SelectedValue.ToString & "&cid=" & cmbCliente.SelectedValue.ToString)
        Else
            rwAlerta.RadAlert("Seleccione un periodo.", 330, 180, "Alerta", "", "")
        End If
    End Sub
    Private Sub LlenaComboPeriodosCatorcenal(ByVal sel As Integer)
        ...
        If dt.Rows.Count > 0 Then
            ...
            For Each oDataRow In dt.Rows
                ...
                ElseIf oDataRow("ClaveRegimenContratacion") >= 5 Then 'Asimilados a salarios
                    ImportePeriodo = oDataRow("AsimiladoTotalCatorcenal")
                ...
                ''''''// Consultar SI tiene ADEUDO FONACOT //'''''''
                datos = New DataTable
                Dim Fonacot As New Entities.Fonacot()
                Fonacot.IdEmpresa = Session("clienteid")
                ...
                PrestamoPersonal.IdEmpresa = Session("clienteid")
                ...
                If datos.Rows.Count > 0 Then
                    ...
                    If dts.Rows.Count > 0 Then
                        For Each row In dts.Rows
                            ...
                            cPrestamoPersonal.TipoNomina = 2 'Catorcenal
    ...
    Private Sub ChecarPercepcionesGravadas(ByVal NoEmpleado As Int64, ByVal CvoConcepto As Int32, ByVal ImporteIncidencia As Decimal, ByVal UnidadIncidencia As Decimal)
        Try
            ...
            End If
            If PrimaVacacional > 0 And PrimaVacacional < (SalarioMinimoDiarioGeneral * 14) Then
                ImporteExento = ImporteExento + PrimaVacacional
            ElseIf PrimaVacacional > 0 And PrimaVacacional > (SalarioMinimoDiarioGeneral * 14) Then
                ImporteExento = ImporteExento + (SalarioMinimoDiarioGeneral * 14)
                ImporteGravado = ImporteGravado + (PrimaVacacional - (SalarioMinimoDiarioGeneral * 14))
            End If
            If RepartoUtilidades > 0 And RepartoUtilidades < (SalarioMinimoDiarioGeneral * 14) Then
                ImporteExento = ImporteExento + RepartoUtilidades
            ElseIf RepartoUtilidades > 0 And RepartoUtilidades > (SalarioMinimoDiarioGeneral * 14) Then
                ImporteExento = ImporteExento + (SalarioMinimoDiarioGeneral * 14)
                ImporteGravado = ImporteGravado + (RepartoUtilidades - (SalarioMinimoDiarioGeneral * 14))
            End If
    ...
    Private Sub grdEmpleadosCatorcenal_NeedDataSource(sender As Object, e As GridNeedDataSourceEventArgs) Handles grdEmpleadosCatorcenal.NeedDataSource
        ...
        cNomina.TipoNomina = 2 'Catorcenal
        cNomina.Periodo = cmbPeriodo.SelectedValue
        grdEmpleadosCatorcenal.DataSource = cNomina.ConsultarDetalleNomina()
        cNomina = Nothing
    End Sub
    ...
    Private Sub GuardarExentoYGravado(ByVal NoEmpleado, ByVal NoConceptoGravado, ByVal NoConceptoExento, ByVal ImporteGravado, ByVal ImporteExento)
        ...
        End Try
    End Sub
    Public Sub CrearCFDNominaCatorcenal(ByVal NoEmpleado As Integer, ByVal RutaXML As String)
    ...
    Private Function CrearDOM() As XmlDocument
        ...
        CrearDOM = oDOM
    End Function
    Private Function CrearNodoComprobante(ByVal NoEmpleado As Int32) As XmlNode
    ...
    End Sub
    Private Sub btnTimbrarNominaCatorcenal_Click(sender As Object, e As EventArgs) Handles btnTimbrarNominaCatorcenal.Click
        ...
        If dt.Rows.Count > 0 Then
            For Each row As DataRow In dt.Rows
                Try
                    ...
                    FolioXml = Server.MapPath("~\XmlTimbrados\").ToString & RfcEmisor.ToString & "\" & RfcCliente.ToString & "\C\" & IdEjercicio.ToString & "\" & cmbPeriodo.SelectedValue.ToString & "\" & UUID & ".xml"
                    ...
                    Dim FilePath = Server.MapPath("~/CBB/C/" & UUID.ToString & ".png")
                    If Not File.Exists(FilePath) Then
                        CodigoBidimensional(FolioXml)
                    End If

                    reporte.ReportParameters("paramImgCBB").Value = Server.MapPath("~/CBB/C/" & UUID.ToString & ".png")
    ...
    Private Sub CodigoBidimensional(ByVal RutaXml As String)
        ...
        CBidimensional.Save(Server.MapPath("~/CBB/C/") & UUID & ".png", System.Drawing.Imaging.ImageFormat.Png)
    End Sub
    Private Sub btnConfirmarGeneraNominaElectronica_Click(sender As Object, e As EventArgs) Handles btnConfirmarGeneraNominaElectronica.Click
        ...
        If cmbPeriodo.SelectedValue > 0 Then
            ...
            rutaEmpresa = Server.MapPath("~\XmlGenerados\").ToString & RfcEmisor.ToString & "\" & RfcCliente.ToString & "\C\" & IdEjercicio.ToString & "\" & cmbPeriodo.SelectedValue.ToString
            ...
            If dt.Rows.Count > 0 Then
                ...
                For Each oDataRow In dt.Rows
                    ...
                    CrearCFDNominaCatorcenal(oDataRow("NoEmpleado"), rutaEmpresa)
            ...
            ElseIf dt.Rows.Count = 0 Then
                rwAlerta.RadAlert("Esta nomina ya esta generada completamente!!!", 330, 180, "Alerta", "", "")
            End If
        Else
            rwAlerta.RadAlert("Seleccione un periodo.", 330, 180, "Alerta", "", "")
        End If
                ...
                For Each oDataRow In dt.Rows
                    ...
                    Try
                        ...
                        If dtCreditoFonacot.Rows.Count > 0 Then
                            ...
                            cFonacot.TipoNomina = 2 'Catorcenal
                        ...
                        If dtPrestamosPersonal.Rows.Count > 0 Then
                            ...
                            cPrestamoPersonal.IdEmpresa = Session("clienteid")
                            cPrestamoPersonal.NoEmpleado = oDataRow("NoEmpleado")
                            cPrestamoPersonal.Ejercicio = IdEjercicio
                            cPrestamoPersonal.TipoNomina = 2 'Catorcenal
                            cPrestamoPersonal.Periodo = cmbPeriodo.SelectedValue
    ...
    Private Sub Comprimir()
        ...
        data = ms.ToArray
    End Sub
    Private Sub Descomprimir(ByVal data5 As Byte(), ByVal NoEmpleado As Integer)
        ...
        DirectorioExtraccion = Server.MapPath("~\XmlTimbrados\").ToString & RfcEmisor.ToString & "\" & RfcCliente.ToString & "\C\" & IdEjercicio.ToString & "\" & cmbPeriodo.SelectedValue.ToString
        ...
        If File.Exists(DirectorioExtraccion & "\" & archivo) Then
            ...
            If File.Exists(FolioXml) Then
                ...
                File.Delete(Server.MapPath("~\XmlGenerados\").ToString & RfcEmisor.ToString & "\" & RfcCliente.ToString & "\C\" & IdEjercicio.ToString & "\" & cmbPeriodo.SelectedValue.ToString & "\" & serie.Value.ToString & folio.Value.ToString & ".xml")
            End If
            ...
            If dt.Rows.Count > 0 Then
                ...
                For Each row As DataRow In dt.Rows
                    ...
                    If row("UUID").ToString.Length > 0 Then
                        ...
                        rutaEmpresa = Server.MapPath("~\PDF\").ToString & RfcEmisor.ToString & "\" & RfcCliente.ToString & "\C\" & IdEjercicio.ToString & "\" & cmbPeriodo.SelectedValue.ToString & "\T"
    ...
    Private Sub DownloadXML(ByVal UUID As String)
        ...
        Dim rutaEmpresa As String = ""
        rutaEmpresa = Server.MapPath("~\XmlTimbrados\").ToString & RfcEmisor.ToString & "\" & RfcCliente.ToString & "\C\" & IdEjercicio.ToString & "\" & cmbPeriodo.SelectedValue.ToString
                ...
                For Each row In dt.Rows
                    ...
                    If validos.Length > 0 Then
                        ...
                        Try
                            ...
                            mensaje = "Adjunto a este correo estamos enviándole el Comprobante de Nómina correspondiente al periodo del " & fecha_inicial & " al " & fecha_final & " Cualquier duda o comentario estamos a sus  órdenes." & vbCrLf
            ...
            If dt.Rows.Count > 0 Then
                Using zip As ZipFile = New ZipFile()
                    ...
                    For Each row In dt.Rows
                        ...
                        rutaEmpresa = Server.MapPath("~\XmlTimbrados\" & RfcEmisor & "\" & RfcCliente.ToString & "\C\").ToString & IdEjercicio.ToString & "\" & cmbPeriodo.SelectedValue.ToString
