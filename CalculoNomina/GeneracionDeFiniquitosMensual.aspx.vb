...
Public Class GeneracionDeFiniquitosMensual
    ...
    Private Sub btnConfirmarTimbraFiniquito_Click(sender As Object, e As EventArgs) Handles btnConfirmarTimbraFiniquito.Click
        Try
            ...
            Dim FilePath1 = Server.MapPath("~\PDF\").ToString & RfcEmisor.ToString & "\" & RfcCliente.ToString & "\M\" & IdEjercicio.ToString & "\F\" & cmbPeriodo.SelectedValue.ToString & "\" & "F" & String.Format("{0:00}", empleadoId.Value) & ".pdf"
            Call GuardaPDF(GeneraPDFFiniquito(), FilePath1)

            Dim FilePath2 = Server.MapPath("~\PDF\").ToString & RfcEmisor.ToString & "\" & RfcCliente.ToString & "\M\" & IdEjercicio.ToString & "\F\" & cmbPeriodo.SelectedValue.ToString & "\" & "R" & String.Format("{0:00}", empleadoId.Value) & ".pdf"
    ...
    Private Sub btnDescargarPDFFiniquito_Click(sender As Object, e As EventArgs) Handles btnDescargarPDFFiniquito.Click
        ...
        Dim FilePath = Server.MapPath("~\PDF\").ToString & RfcEmisor.ToString & "\" & RfcCliente.ToString & "\M\" & IdEjercicio.ToString & "\F\" & cmbPeriodo.SelectedValue.ToString & "\" & "F" & String.Format("{0:00}", empleadoId.Value) & ".pdf"
    ...
    Private Sub btnDescargarPDFRenuncia_Click(sender As Object, e As EventArgs) Handles btnDescargarPDFRenuncia.Click
        ...
        Dim FilePath = Server.MapPath("~\PDF\").ToString & RfcEmisor.ToString & "\" & RfcCliente.ToString & "\M\" & IdEjercicio.ToString & "\F\" & cmbPeriodo.SelectedValue.ToString & "\" & "R" & String.Format("{0:00}", empleadoId.Value) & ".pdf"
        If File.Exists(FilePath) Then
            Dim FileName As String = Path.GetFileName(FilePath)
            Response.Clear()
            Response.ContentType = "application/octet-stream"
