<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="ListadoNominaNormalCatorcenal.aspx.vb" Inherits="CalculoNomina.ListadoNominaNormalCatorcenal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OpenWindow(empresaid, ejercicioid, periodoid) {
            var oWnd = radopen("RptNominaCatorcenal.aspx?e=" + empresaid + "&ej=" + ejercicioid + "&p=" + periodoid, "wndReporte");
            oWnd.set_modal(true);
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:HiddenField ID="periodoID" runat="server" Value="0" Visible="False" />
        ...
        <div class="ibox-content" style="border: solid 0px">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="m-t-none m-b">Listado de nómina ordinaria catorcenal</h1>
