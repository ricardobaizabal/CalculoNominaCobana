<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="ModificacionGeneralMensual.aspx.vb" Inherits="CalculoNomina.ModificacionGeneralMensual" %>

<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        function OpenWindow(id, empleadoid, contratoid, nominaid) {
            var wnd = $find('<%=RadWindow1.ClientID%>');
            var oWnd = radopen("IncidenciasMensual.aspx?id=" + id + "&empleadoid=" + empleadoid + "&contratoid=" + contratoid + "&nominaid=" + nominaid, "RadWindow1");
            oWnd.set_modal(true);
            ...
            oWnd.set_title("Modificación de nómina ordinaria mensual - Incidencias")
            oWnd.center();
        }
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" HorizontalAlign="NotSet" LoadingPanelID="RadAjaxLoadingPanel1" ClientEvents-OnRequestStart="OnRequestStart">
        ...
        <div class="ibox-content" style="border: solid 0px">
            ...
            <div class="row">
                <div class="col-md-12">
                    <telerik:RadGrid ID="grdEmpleadosMensual" runat="server" AutoGenerateColumns="false" AllowPaging="false" AllowSorting="true" ShowFooter="true" ExportSettings-ExportOnlyData="false" ShowStatusBar="true" PageSize="20" CellSpacing="0" GridLines="None" Skin="Bootstrap" AllowFilteringByColumn="true">
