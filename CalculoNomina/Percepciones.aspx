<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="Percepciones.aspx.vb" Inherits="CalculoNomina.Percepciones" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" HorizontalAlign="NotSet" LoadingPanelID="RadAjaxLoadingPanel1">
        <div class="col-lg-12 b-r">
            <br />
            <br />
            <h3 class="m-t-none m-b">Percepciones</h3>
            <hr class="demo-separator" />
            <br />
            <telerik:RadGrid ID="GridPercepciones" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="20"
        ...
        <asp:Panel ID="panelPerpeciones" runat="server" Visible="False">
            <asp:HiddenField ID="FiniquitoId" runat="server" Value="0" />
                <table border="0" cellpadding="3" width="100%">
                    <tr style="vertical-align: top;">
                        <td colspan="8" class="ulwrapperblue">
                            <asp:Label ID="Label8" runat="server" CssClass="TitleBaja" Font-Bold="True" Text="Sección de Percepciones"></asp:Label>
                        </td>
                    </tr>
                    ...
                    <tr style="vertical-align: top;">
                        ...
                        <td style="width: 65%;">
                            ...
                            <telerik:RadTextBox ID="txtClave" runat="server" ValidationGroup="vPuesto" ></telerik:RadTextBox><br/><br/><br/>
                            <asp:CheckBox ID="checkExcedente" Text="  Excedente  " runat="server"  ValidationGroup="vCodigo" CausesValidation="False" AutoPostBack="True" CssClass="CheckboxExcedente"/>
                        </td>              
                     </tr>
                     <tr style="vertical-align: top;">                     
                 ...
                 <table style="width: 100%;">
                    <tr style="vertical-align: top;">
                        <td width="100%" align="left">
                            <asp:Button ID="btnSavePercepcion" runat="server" Text="Guardar" CssClass="rbPrimaryButton" CausesValidation="False" />&nbsp;&nbsp;
                            <asp:Button ID="btnCancelar" runat="server" Text="Cancelar" CssClass="rbPrimaryButton" CausesValidation="False" />&nbsp;<br /><br />
                            <asp:Label ID="lblMensajePercepcion" runat="server" CssClass="item"></asp:Label>
                        </td>
                    </tr>
                 </table>
            </asp:Panel>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const options = document.querySelectorAll('.dropClaveSAT option');
