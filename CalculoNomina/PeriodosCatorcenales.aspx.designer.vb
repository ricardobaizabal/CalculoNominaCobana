...
Partial Public Class PeriodosCatorcenales
    ...
    '''<summary>
    '''Control GridPeriodosCatorcenales.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents GridPeriodosCatorcenales As Global.Telerik.Web.UI.RadGrid

    '''<summary>
    '''Control rwConfirmEliminaPeriodo.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents rwConfirmEliminaPeriodo As Global.Telerik.Web.UI.RadWindowManager
