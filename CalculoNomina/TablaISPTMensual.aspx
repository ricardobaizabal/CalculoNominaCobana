...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" HorizontalAlign="NotSet" LoadingPanelID="RadAjaxLoadingPanel1">
        <div class="col-lg-12 b-r">
            <br />
            <br />
            <h2 class="m-t-none m-b">TARIFAS ISR RETENCIÓN MENSUAL</h2>
            <hr class="demo-separator" />
            <br />
            <telerik:RadGrid ID="GridTarifaMensual" runat="server" AutoGenerateColumns="false" AllowPaging="false" PageSize="50"
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=localhost; Initial Catalog=nomilink_cobana; Persist Security Info=True; Trusted_Connection=yes; Max Pool Size=360"
        SelectCommand="SELECT IdTarifa, isnull(LimiteInferior,0)as pLimiteInferior, isnull(LimiteSuperior,0)as pLimiteSuperior, isnull(CuotaFija,0)as pCuotaFija, isnull(PorcSobreExcli,0)as pPorcSobreExcli FROM tblTarifaMensual order by LimiteInferior ASC"
        UpdateCommand="UPDATE tblTarifaMensual SET LimiteInferior=@pLimiteInferior, LimiteSuperior=@pLimiteSuperior, CuotaFija=@pCuotaFija, PorcSobreExcli=@pPorcSobreExcli  WHERE  IdTarifa=@IdTarifa">
        <UpdateParameters>
