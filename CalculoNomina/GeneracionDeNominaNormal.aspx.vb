...
Public Class GeneracionDeNominaNormal
    ...
    Protected Sub btnRegresar_Click(sender As Object, e As EventArgs) Handles btnRegresar.Click
        Response.Redirect("ListadoNominaNormal.aspx")
    End Sub
    ...
    Private Sub btnGeneraNomina_Click(sender As Object, e As EventArgs) Handles btnGeneraNomina.Click
        ...
        ElseIf cmbPeriodo.SelectedValue = 0 Then
            rwAlerta.RadAlert("Seleccione un periodo.", 330, 180, "Alerta", "", "")
        ElseIf IsNothing(fchPago.SelectedDate) Then
    ...
    Private Sub btnCrearPeriodoID_Click(sender As Object, e As EventArgs) Handles btnCrearPeriodoID.Click
        ...
        Else
            ...
            fchFinPeriodo.SelectedDate = DateTime.Now.AddDays(7)
        End If
    End Sub
    Private Sub btnModificacionDeNomina_Click(sender As Object, e As EventArgs) Handles btnModificacionDeNomina.Click
        If cmbPeriodo.SelectedValue > 0 Then
            Response.Redirect("~/ModificacionGeneralSemanal.aspx?id=" & cmbPeriodo.SelectedValue.ToString & "&cid=" & cmbCliente.SelectedValue.ToString)
        Else
            rwAlerta.RadAlert("Seleccione un periodo.", 330, 180, "Alerta", "", "")
        End If
    End Sub
    ...
    Private Sub ChecarDeducciones(ByVal NoEmpleado As Integer)
        Try
            ...
            If dt.Rows.Count > 0 Then
                ...
                End If
                If dt.Compute("Sum(IMPORTE)", "CVOCONCEPTO=88") IsNot DBNull.Value Then
                    SubsidioAplicado = dt.Compute("Sum(IMPORTE)", "CVOCONCEPTO=88")
                End If
                ...
                If dt.Compute("Sum(IMPORTE)", "CVOCONCEPTO=11") IsNot DBNull.Value Then
                    CuotaImss = dt.Compute("Sum(IMPORTE)", "CVOCONCEPTO=11")
                End If
    ...
    Private Sub CrearNodoReceptor(ByVal Nodo As XmlNode, ByVal NoEmpleado As Integer)
        ...
        If dtReceptor.Rows.Count > 0 Then
            For Each oDataRow In dtReceptor.Rows
                ...
                Receptor.SetAttribute("RegimenFiscalReceptor", "605") 'Sueldos y Salarios e Ingresos Asimilados a Salarios
    ...
    Public Function GetCadenaOriginal(ByVal xmlCFD As String) As String
        ...
        'xslt.Load(Server.MapPath("~/SAT/") & "cadenaoriginal_4_0.xslt")
    ...
    Private Sub btnConfirmarGeneraNominaElectronica_Click(sender As Object, e As EventArgs) Handles btnConfirmarGeneraNominaElectronica.Click
        ...
        If cmbPeriodo.SelectedValue > 0 Then
            ...
            rutaEmpresa = Server.MapPath("~\XmlGenerados\").ToString & RfcEmisor.ToString & "\" & RfcCliente.ToString & "\S\" & IdEjercicio.ToString & "\" & cmbPeriodo.SelectedValue.ToString
    ...
    Private Function Descomprimir(ByVal data5 As Byte(), ByVal NoEmpleado As Integer)
        ...
        DirectorioExtraccion = Server.MapPath("~\XmlTimbrados\").ToString & RfcEmisor.ToString & "\" & RfcCliente.ToString & "\S\" & IdEjercicio.ToString & "\" & cmbPeriodo.SelectedValue.ToString
        ...
        If cmbPeriodo.SelectedValue > 0 Then
            ...
            If dt.Rows.Count > 0 Then
                ...
                If total_banorte > 0 Then
                    ...
                    ruta_banorte = Server.MapPath("~/TXT/BANORTE/S/").ToString & IdEjercicio.ToString & "/" & Periodo.ToString & "/"
                ...
                If total_banamex > 0 Then
                    ...
                    ruta_banamex = Server.MapPath("~/TXT/BANAMEX/S/").ToString & IdEjercicio.ToString & "/" & Periodo.ToString & "/"
                    ...
                    If total_banamex > 0 Then
                        ...
                        If datos.Rows.Count > 0 Then
                            ...
                            For Each registro In datos.Rows
                                ...
                                archivo = String.Format("{0:000000000000}", CInt(registro("emisora"))) & CDate(registro("fecha_proceso")).ToString("ddMMyyyy").ToString & String.Format("{0:0000}", registro("consecutivo")) & ".dat"
                ...
                Using zip As ZipFile = New ZipFile()
                    ...
                    ruta = Server.MapPath("~\TXT\S\").ToString & IdEjercicio.ToString & "\" & Periodo.ToString & "\"
                    ...
                    Dim FilePath As String = ruta & Format(cPeriodo.FechaInicialDate, "dd-MM-yyyy").ToString & "_" & Format(cPeriodo.FechaFinalDate, "dd-MM-yyyy").ToString & ".rar"
                    zip.Save(FilePath)
    ...
    Private Sub btnCancelarPeriodo_Click(sender As Object, e As EventArgs) Handles btnCancelarPeriodo.Click
        WinPeriodoSave.VisibleOnPageLoad = False
    End Sub
    Private Sub fchInicioPeriodo_SelectedDateChanged(sender As Object, e As SelectedDateChangedEventArgs) Handles fchInicioPeriodo.SelectedDateChanged
        Dim fechaInicio As Date = fchInicioPeriodo.SelectedDate
        fchFinPeriodo.SelectedDate = fechaInicio.AddDays(6)
        fchFinPeriodo.Enabled = False
    End Sub
