<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GeneracionDeNominaMensualNormal.aspx.vb" MasterPageFile="~/MasterPage.Master" Inherits="CalculoNomina.GeneracionDeNominaMensualNormal" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" HorizontalAlign="NotSet" LoadingPanelID="RadAjaxLoadingPanel1" ClientEvents-OnRequestStart="OnRequestStart">
        ...
        <div class="ibox-content" style="border: solid 0px">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="m-t-none m-b">Generación de nómina ordinaria mensual</h1>
                    ...
                    <div class="form-horizontal">
                        <div class="form-group">
                            <table style="width: 100%; border-collapse: separate; border-spacing: 10px;">
                                <tr>
                                    <td>
                                        <label class="control-label">Seleccionar Cliente</label><br />
                                    </td>
                                    <td>
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-2 col-sm-2">
                    <div class="form-group">
                        <telerik:RadButton ID="btnTimbrarNominaMensual" RenderMode="Lightweight" Enabled="false" runat="server" Width="141px" Height="50px">
            ...
            <asp:Panel runat="server" ID="panelDatos" Visible="false">
                ...
                <fieldset>
                    ...
                    <div class="form-group row">
                        <telerik:RadGrid ID="grdEmpleadosMensual" runat="server" AutoGenerateColumns="False" AllowPaging="True" AllowSorting="True" ShowFooter="True" ShowHeader="True" PageSize="50" CellSpacing="0" GridLines="None" Skin="Bootstrap" ExportSettings-ExportOnlyData="False">
                            ...
                            <MasterTableView NoMasterRecordsText="No hay registros para mostrar." DataKeyNames="NoEmpleado,RFC" CommandItemDisplay="Top">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="Neto" DataFormatString="{0:C}" ItemStyle-HorizontalAlign="Right" HeaderText="Neto" UniqueName="Neto" Aggregate="Sum" FooterStyle-Font-Bold="true" FooterStyle-HorizontalAlign="Right"></telerik:GridBoundColumn>
