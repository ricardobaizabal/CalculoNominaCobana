<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="FiniquitosCatorcenal.aspx.vb" Inherits="CalculoNomina.FiniquitosCatorcenal" %>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 b-r">
                        ...
                        <div class="form-horizontal">
                            <div class="row">
                                ...
                                <div class="col-lg-2 text-left">
                                    <telerik:RadButton ID="btnSearch" RenderMode="Lightweight" runat="server" Skin="Bootstrap" Text="Buscar"></telerik:RadButton>
                                </div>
                                <div class="col-lg-6">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <fieldset>
                            <h1 class="m-t-none m-b">Generación de Finiquitos Catorcenal</h1>
