...
Imports Entities
Public Class ModificacionGeneralExtraordinaria
    ...
    Private Sub grdEmpleadosSemanal_ItemDataBound(sender As Object, e As GridItemEventArgs) Handles grdEmpleadosSemanal.ItemDataBound
        If TypeOf e.Item Is GridDataItem Then
            ...
            lnkEditar.Attributes.Add("onclick", "javascript: OpenWindow('" & periodoId.Value.ToString & "','" & item.GetDataKeyValue("NoEmpleado").ToString & "','" & item.GetDataKeyValue("IdContrato").ToString & "'); return false;")
    ...
    Private Sub btnRegresar_Click(sender As Object, e As EventArgs) Handles btnRegresar.Click
        If Not String.IsNullOrEmpty(Request("id")) Then
            Response.Redirect("~/GeneracionDeNominaExtraordinaria.aspx?id=" & periodoId.Value.ToString, False)
        Else
            Response.Redirect("~/GeneracionDeNominaExtraordinaria.aspx", False)
        End If
    End Sub
