<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="ListadoNominaExtraordinaria.aspx.vb" Inherits="CalculoNomina.ListadoNominaExtraordinaria" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" HorizontalAlign="NotSet" LoadingPanelID="RadAjaxLoadingPanel1" ClientEvents-OnRequestStart="OnRequestStart">
        ...
        <div class="ibox-content" style="border: solid 0px">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="m-t-none m-b">Listado de nómina extraordinaria</h1>
                        ...
                        <div class="form-group">
                            <table style="width: 100%; border-collapse: separate; border-spacing: 10px;">
                                <tr>
                                    ...
                                    <td>
                                        <telerik:RadComboBox ID="cmbCliente" runat="server" Width="500px" AutoPostBack="false"></telerik:RadComboBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 20%;">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <telerik:RadGrid ID="GridNominas" runat="server" AutoGenerateColumns="False" AllowPaging="True" AllowSorting="True" ShowFooter="False" ShowHeader="True" PageSize="50" CellSpacing="0" GridLines="None" Skin="Bootstrap" ExportSettings-ExportOnlyData="False">
                            ...
                            <Columns>
                                <telerik:GridTemplateColumn AllowFiltering="False" HeaderStyle-HorizontalAlign="Center" HeaderText="Folio">
                                    <ItemTemplate>
                                        ...
                                        <%--<asp:ImageButton ID="lnkEdit" runat="server" CommandArgument='<%# Eval("Folio") %>' CommandName="cmdEdit" ImageUrl="~/images/action_edit.png" />--%>
                                    </ItemTemplate>
                                ...
                                <telerik:GridBoundColumn DataField="FechaRango" ItemStyle-HorizontalAlign="Left" HeaderText="Periodo de Pago" UniqueName="PeriodoDePago">
                                </telerik:GridBoundColumn>
