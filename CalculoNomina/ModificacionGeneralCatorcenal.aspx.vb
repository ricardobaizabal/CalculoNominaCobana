...
Public Class ModificacionGeneralCatorcenal
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            If Not String.IsNullOrEmpty(Request("id")) Then
                ...
                grdEmpleadosCatorcenal.MasterTableView.GetColumn("Comisiones").Display = False
                grdEmpleadosCatorcenal.MasterTableView.GetColumn("Faltas").Display = False
                grdEmpleadosCatorcenal.MasterTableView.GetColumn("HorasDobles").Display = False
                grdEmpleadosCatorcenal.MasterTableView.GetColumn("HorasTriples").Display = False
                grdEmpleadosCatorcenal.MasterTableView.GetColumn("PremioAsistencia").Display = False
                grdEmpleadosCatorcenal.MasterTableView.GetColumn("PremioPuntualidad").Display = False
                grdEmpleadosCatorcenal.MasterTableView.GetColumn("PrimaDominical").Display = False
            End If
        End If
    End Sub
    ...
    Private Sub cmbIncidencias_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbIncidencias.SelectedIndexChanged
        ...
        ElseIf cmbIncidencias.SelectedValue = 3 Then    'COMISION
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("Comisiones").Display = True
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("Faltas").Display = False
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("HorasDobles").Display = False
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("HorasTriples").Display = False
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("PremioAsistencia").Display = False
        ...
        ElseIf cmbIncidencias.SelectedValue = 6 Then    'HORAS DOBLES
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("Comisiones").Display = False
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("Faltas").Display = False
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("HorasDobles").Display = True
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("HorasTriples").Display = False
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("PremioAsistencia").Display = False
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("PremioPuntualidad").Display = False
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("PrimaDominical").Display = False
        ElseIf cmbIncidencias.SelectedValue = 7 Then    'HORAS TRIPLES
            ...
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("Faltas").Display = False
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("HorasDobles").Display = False
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("HorasTriples").Display = True
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("PremioAsistencia").Display = False
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("PremioPuntualidad").Display = False
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("PrimaDominical").Display = False
        ElseIf cmbIncidencias.SelectedValue = 13 Then    'PRIMA DOMINICAL
            ...
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("PremioAsistencia").Display = False
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("PremioPuntualidad").Display = False
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("PrimaDominical").Display = True
        ElseIf cmbIncidencias.SelectedValue = 23 Then    'PREMIO ASISTENCIA
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("Comisiones").Display = False
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("Faltas").Display = False
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("HorasDobles").Display = False
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("HorasTriples").Display = False
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("PremioAsistencia").Display = True
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("PremioPuntualidad").Display = False
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("PrimaDominical").Display = False
        ElseIf cmbIncidencias.SelectedValue = 24 Then    'PREMIO PUNTUALIDAD
            ...
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("HorasTriples").Display = False
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("PremioAsistencia").Display = False
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("PremioPuntualidad").Display = True
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("PrimaDominical").Display = False
        ElseIf cmbIncidencias.SelectedValue = 57 Then    'FALTAS
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("Comisiones").Display = False
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("Faltas").Display = True
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("HorasDobles").Display = False
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("HorasTriples").Display = False
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("PremioAsistencia").Display = False
            grdEmpleadosCatorcenal.MasterTableView.GetColumn("PremioPuntualidad").Display = False
        ...
        Try
            ...
            If PrevisionSocial > 0 Then
                ...
                ElseIf ImporteGravado + ImporteExento + PrevisionSocial > ((SalarioMinimoDiarioGeneral * 14) * 14) And ImporteGravado + ImporteExento > ((SalarioMinimoDiarioGeneral * 14) * 14) Then
                    ImporteExento = ImporteExento + (SalarioMinimoDiarioGeneral * 14)
                    ImporteGravado = ImporteGravado + (PrevisionSocial - (SalarioMinimoDiarioGeneral * 14))
                    ImporteExentoPrevisionSocial = SalarioMinimoDiarioGeneral * 14
                    ImporteGravadoPrevisionSocial = PrevisionSocial - (SalarioMinimoDiarioGeneral * 14)
                ElseIf ImporteGravado + ImporteExento + PrevisionSocial > ((SalarioMinimoDiarioGeneral * 14) * 14) And ImporteGravado + ImporteExento + SalarioMinimoDiarioGeneral < ((SalarioMinimoDiarioGeneral * 14) * 14) Then
                    ImporteExento = ImporteExento + (((SalarioMinimoDiarioGeneral * 14) * 14) - (ImporteGravado + ImporteExento))
                    ImporteGravado = ImporteGravado + (PrevisionSocial - (((SalarioMinimoDiarioGeneral * 14) * 14) - (ImporteGravado + ImporteExento)))
                    ImporteExentoPrevisionSocial = ((SalarioMinimoDiarioGeneral * 14) * 14) - (ImporteGravado + ImporteExento)
                    ImporteGravadoPrevisionSocial = PrevisionSocial - (((SalarioMinimoDiarioGeneral * 14) * 14) - (ImporteGravado + ImporteExento))
                ElseIf ImporteGravado + ImporteExento + PrevisionSocial > ((SalarioMinimoDiarioGeneral * 14) * 14) And (((SalarioMinimoDiarioGeneral * 14) * 14) - (ImporteGravado + ImporteExento) < SalarioMinimoDiarioGeneral * 14) Then
                    ImporteExento = ImporteExento + (SalarioMinimoDiarioGeneral * 14)
                    ImporteExentoPrevisionSocial = SalarioMinimoDiarioGeneral * 14
                    ImporteGravadoPrevisionSocial = 0
    ...
    Private Sub CalcularImpuesto()
        Try
            Impuesto = 0
            Dim ImporteCatorcenal As Decimal
            ImporteCatorcenal = ImporteDiario * (DiasCuotaPeriodo + DiasVacaciones + DiasPagoPorHoras + DiasComision + DiasDestajo + DiasHonorarioAsimilado)
            Dim dt As New DataTable()
            Dim TarifaSemanal As New TarifaSemanal()
            TarifaSemanal.ImporteSemanal = ImporteCatorcenal
            dt = TarifaSemanal.ConsultarTarifa()

            If dt.Rows.Count > 0 Then
                Impuesto = ((ImporteCatorcenal - dt.Rows(0).Item("LimiteInferior")) * (dt.Rows(0).Item("PorcSobreExcli") / 100)) + dt.Rows(0).Item("CuotaFija")
            End If
        Catch oExcep As Exception
            rwAlerta.RadAlert(oExcep.Message.ToString, 330, 180, "Alerta", "", "")
        End Try
    ...
    Private Sub CalcularSubsidio()
        Try
            ...
            TablaSubsidioSemanal.ImporteSemanal = ImporteCatorcenal
