<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="ModificacionGeneralExtraordinaria.aspx.vb" Inherits="CalculoNomina.ModificacionGeneralExtraordinaria" %>

<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        function OpenWindow(id, empleadoid, contratoid) {
            //alert("IncidenciasWindow.aspx?id=" + id + "&empleadoid=" + empleadoid + "&contratoid=" + contratoid);
            var wnd = $find('<%=RadWindow1.ClientID%>');
            var oWnd = radopen("IncidenciasExtraordinaria.aspx?id=" + id + "&empleadoid=" + empleadoid + "&contratoid=" + contratoid, "RadWindow1");
            oWnd.set_modal(true);
            oWnd.set_centerIfModal(true);
            //oWnd.set_visibleStatusbar(false);
            oWnd.setSize(1200, 768);
            oWnd.set_behaviors(Telerik.Web.UI.WindowBehaviors.Close);
            oWnd.set_autoSize(false);
            oWnd.set_title("Modificación de nómina extraordinaria - Incidencias")
            oWnd.center();
        }
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" HorizontalAlign="NotSet" LoadingPanelID="RadAjaxLoadingPanel1" ClientEvents-OnRequestStart="OnRequestStart">
        ...
        <div class="ibox-content" style="border: solid 0px">
            <div class="row">
                <div class="form-group row">
                    <table style="width: 100%;" border="0">
                        ...
                        <tr style="height: 30px;">
                            ...
                            <td colspan="2">
                                <asp:DropDownList ID="cmbIncidencias" runat="server" AutoPostBack="true" Width="100%"></asp:DropDownList>
                            </td>
                            <td colspan="3">&nbsp;</td>
                        </tr>
                    </table>
                ...
                <div class="form-group row">
                    <telerik:RadGrid ID="grdEmpleadosSemanal" runat="server" AutoGenerateColumns="False" AllowPaging="True" AllowSorting="True" ExportSettings-ExportOnlyData="false" ShowStatusBar="true" PageSize="20" CellSpacing="0" GridLines="None" Skin="Bootstrap" AllowFilteringByColumn="true">
        ...
        <telerik:RadWindowManager ID="RadWindowManager1" VisibleStatusbar="false" runat="server" OnClientClose="OnClientCloseHandler">
            <Windows>
                <telerik:RadWindow ID="RadWindow1" VisibleStatusbar="false" runat="server" OnClientClose="OnClientCloseHandler" Style="z-index: 7001" BackColor="White" RenderMode="Lightweight" Skin="Bootstrap">
                </telerik:RadWindow>
            </Windows>
