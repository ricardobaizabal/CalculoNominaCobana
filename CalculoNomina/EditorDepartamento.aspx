<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="EditorDepartamento.aspx.vb" Inherits="CalculoNomina.EditorDepartamento" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" HorizontalAlign="NotSet" LoadingPanelID="RadAjaxLoadingPanel1">
        <div class="col-lg-12 b-r">
            <br />
            <br />
            <h3 class="m-t-none m-b">Editar Departamento</h3>
            ...
            <table style="width: 100%;" border="0">
                ...
                <tr style="vertical-align: top;">
                    ...
                    <td style="width: 30%;">
                        <telerik:RadTextBox ID="txtDepartamento" runat="server" Width="350px" ValidationGroup="vgDepartamento"></telerik:RadTextBox>&nbsp;
                    ...
                    <td style="text-align: left;">
                        <telerik:RadButton ID="btnGuardar" runat="server" Text="Guardar" Skin="Bootstrap" CssClass="rbPrimaryButton" ValidationGroup="vgDepartamento" CausesValidation="true">
                        </telerik:RadButton>
                    </td>
                </tr>
                <tr>
