...
Public Class ResumenNominaQuincenal
    ...
    Private Sub GenerarPDF()
        ...
        Dim archivoPdf As String = Path.Combine(FilePath, "ResumenNominaQuinenal " + periodoSimboloCambiado + ".pdf")
        ...
        ' Agregar un título
        Dim titulo As New Paragraph("RESUMEN DE NÓMINA QUINCENAL", FontFactory.GetFont(FontFactory.HELVETICA_BOLD, 12, New BaseColor(39, 17, 149)))
